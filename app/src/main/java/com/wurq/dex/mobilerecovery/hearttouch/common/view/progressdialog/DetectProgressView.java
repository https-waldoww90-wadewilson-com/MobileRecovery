 ...
 * Created
 */
public class DetectProgressView extends View {

    private final static String TAG = "DetectProgressView";
    /**
     * 画笔对象的引用
     */
    private Paint paint;
    ...
    public DetectProgressView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DetectProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public synchronized void setProgress(int progress) {
        Log.d("DetectProgressView", String.valueOf(progress));
        if(progress < 0){
        ...
        if(progress <= max){
            ...
            postInvalidate();
            android.util.Log.i(TAG, "setProgress: postInvalidate");
        }
    }
