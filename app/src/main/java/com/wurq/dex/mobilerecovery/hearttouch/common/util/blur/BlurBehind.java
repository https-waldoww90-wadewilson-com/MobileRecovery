package com.wurq.dex.mobilerecovery.hearttouch.common.util.blur;
...
import com.wurq.dex.mobilerecovery.hearttouch.common.util.blur.util.Blur;
...
public class BlurBehind {
    ...
    public void setBackground(Activity activity) {
        if (mImageCache.size() != 0) {
            ...
            activity.getWindow().setBackgroundDrawableResource(R.color.transparent_black_60);
        }
    }
...
//                stackBlurManager = new StackBlurManager(image);
//                Bitmap blurredBitmap = stackBlurManager.process(CONSTANT_BLUR_RADIUS);
