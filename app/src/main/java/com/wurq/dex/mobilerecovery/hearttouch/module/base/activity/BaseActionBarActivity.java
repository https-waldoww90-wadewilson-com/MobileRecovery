...
import com.wurq.dex.mobilerecovery.hearttouch.common.view.navigationbar.NavigationBar;
...
//        if (isFromTop != isFromScreenTop) {
//            if (isFromTop) {
//                contentView.setPadding(0, 0, 0, 0);
//            }
//            else {
//                float actionBarHeight = ResourcesUtil.getDimen(R.dimen.action_bar_height);
//                if (navigationBarContainer.getHeight() > 0) {
//                    actionBarHeight = navigationBarContainer.getHeight();
//                }
//                contentView.setPadding(0, (int) actionBarHeight, 0, 0);
//            }
//            isFromScreenTop = isFromTop;
//        }
//    }
    ...
    public void setShowRightView(boolean bShow){
        navigationBar.showRightView(bShow);
    }
    ...
    public void setRightButtonEnable(Boolean enable){
        navigationBar.setRightButtonEnable(enable);
    }
